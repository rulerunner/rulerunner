class zcl_rulerunner definition
  ...
  public section.
    ...
    types: tyv_delta_mode type char1 .
...
*    define Key-fields
    ...
    if ir_target_data is bound.
      es_meta_eventtype-ref_target = ir_target_data.
    endif.
...
*      Map BRF-result to Target-Result
      call method zcl_rulerunner=>move_data_source_to_target
        exporting
...
*    append ls_resultgroups to lt_resultgroups.
*
    data: lt_event_id type tyt_event_id.
