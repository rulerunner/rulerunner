...
public section.
  ...
  types:
  begin of TS_ES_PARAMETERS,
     VALUE type C length 60,
     KEY type ZRULERUN_KEY,
  end of TS_ES_PARAMETERS. .
  types:
TT_ES_PARAMETERS type standard table of TS_ES_PARAMETERS. .
  types:
  ...
  end of TS_IS_PARAMETERS. .
  types:
TT_IS_PARAMETERS type standard table of TS_IS_PARAMETERS. .

  constants GC_ES_PARAMETERS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ES_Parameters' ##NO_TEXT.
  constants GC_IS_PARAMETERS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'IS_Parameters' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_ES_PARAMETERS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_IS_PARAMETERS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
define_es_parameters( ).
define_is_parameters( ).
define_associations( ).
  endmethod.
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'it_to_et' "#EC NOTEXT
                            iv_left_type        = 'IS_Parameters' "#EC NOTEXT
                            iv_right_type       = 'ES_Parameters' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - it_to_et
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'IvEventType'   iv_dependent_property = 'Key' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'it_to_etSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'IT_Parameters'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ET_Parameters'             "#EC NOTEXT
                                              iv_association_name      = 'it_to_et' ).                                 "#EC NOTEXT
...
* Navigation Properties for entity - IS_Parameters
lo_entity_type = model->get_entity_type( iv_entity_name = 'IS_Parameters' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'it_to_et' "#EC NOTEXT
                                                              iv_abap_fieldname = 'IT_TO_ET' "#EC NOTEXT
                                                              iv_association_name = 'it_to_et' ). "#EC NOTEXT
  endmethod.


  method DEFINE_ES_PARAMETERS.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - ES_Parameters
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ES_Parameters' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZRULERUNNER_ODATA_MPC=>TS_ES_PARAMETERS' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ET_Parameters' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - IS_Parameters
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'IS_Parameters' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZRULERUNNER_ODATA_MPC=>TS_IS_PARAMETERS' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'IT_Parameters' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20180621130903'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'ES_Parameters'.                            "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'IS_Parameters'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
